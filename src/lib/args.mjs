...
const VALUE_FLAGS = new Set([
  ...
  "ride-tunnel-below-m", "ride-tunnel-cover-m", "ride-support-spacing-m",
  "ride-support-min-height-m", "orthophoto", "orthophoto-source",
...
function normalize(options) {
  const numberKeys = [
    ...
    "rideTunnelBelowM", "rideTunnelCoverM", "rideSupportSpacingM",
    "rideSupportMinHeightM", "orthophotoMaxGsdM", "orthophotoSampleM",
